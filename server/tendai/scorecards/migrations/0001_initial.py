...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ScorecardStory'
        db.create_table('scorecards_scorecardstory', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('submission_worker_device', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devices.SubmissionWorkerDevice'])),
        ))
        db.send_create_signal('scorecards', ['ScorecardStory'])


    def backwards(self, orm):
        
        # Deleting model 'ScorecardStory'
        db.delete_table('scorecards_scorecardstory')
