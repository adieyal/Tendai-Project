...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ORForm.active'
        db.add_column('openrosa_orform', 'active', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ORForm.active'
        db.delete_column('openrosa_orform', 'active')
