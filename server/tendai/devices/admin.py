...
class SubmissionWorkerDeviceAdmin(admin.ModelAdmin):
    ...
    list_filter = ('active', 'community_worker__first_name', 'community_worker__last_name', 'community_worker__organisation__name', 'submission__form__name', 'community_worker__country__name', 'verified', 'valid', 'created_date')
    #date_hierarchy = "created_date"
    actions = [mark_as_invalid, mark_as_valid]
    exclude = ('submission', 'device')
...
admin.site.register(models.MedicineFormMedicines)
