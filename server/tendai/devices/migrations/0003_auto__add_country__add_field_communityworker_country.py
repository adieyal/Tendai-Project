...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('devices_country', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal('devices', ['Country'])

        # Adding field 'CommunityWorker.country'
        db.add_column('devices_communityworker', 'country', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['devices.Country'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'Country'
        db.delete_table('devices_country')

        # Deleting field 'CommunityWorker.country'
        db.delete_column('devices_communityworker', 'country_id')
