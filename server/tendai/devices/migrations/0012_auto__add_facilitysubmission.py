...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'FacilitySubmission'
        db.create_table('devices_facilitysubmission', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('submission', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['openrosa.ORFormSubmission'], null=True)),
            ('facility', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['facility.Facility'], null=True)),
        ))
        db.send_create_signal('devices', ['FacilitySubmission'])


    def backwards(self, orm):
        
        # Deleting model 'FacilitySubmission'
        db.delete_table('devices_facilitysubmission')
