...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'MedicineFormMedicines.country'
        db.delete_column('devices_medicineformmedicines', 'country_id')

        # Deleting field 'MedicineFormMedicines.form'
        db.delete_column('devices_medicineformmedicines', 'form_id')

        # Adding field 'MedicineFormMedicines.countryform'
        db.add_column('devices_medicineformmedicines', 'countryform', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['devices.CountryForm']), keep_default=False)


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'MedicineFormMedicines.country'
        raise RuntimeError("Cannot reverse this migration. 'MedicineFormMedicines.country' and its values cannot be restored.")

        # User chose to not deal with backwards NULL issues for 'MedicineFormMedicines.form'
        raise RuntimeError("Cannot reverse this migration. 'MedicineFormMedicines.form' and its values cannot be restored.")

        # Deleting field 'MedicineFormMedicines.countryform'
        db.delete_column('devices_medicineformmedicines', 'countryform_id')
    ...
    models = {
        ...
        'devices.medicineformmedicines': {
            'Meta': {'object_name': 'MedicineFormMedicines'},
            'countryform': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['devices.CountryForm']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'medicine': ('django.db.models.fields.related.ManyToManyField', [], {'to': "orm['devices.Medicine']", 'symmetrical': 'False'})
        },
        ...
        'devices.submissionworkerdevice': {
            ...
            'active': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'community_worker': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'submissions'", 'null': 'True', 'to': "orm['devices.CommunityWorker']"}),
        ...
        'facility.facility': {
            ...
            'daily_patients': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'distance_to_town': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            'district': ('django.db.models.fields.CharField', [], {'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'doctors': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'nurses': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
            ...
            'population_coverage': ('django.db.models.fields.PositiveIntegerField', [], {'null': 'True', 'blank': 'True'}),
