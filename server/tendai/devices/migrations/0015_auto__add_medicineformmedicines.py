...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'MedicineFormMedicines'
        db.create_table('devices_medicineformmedicines', (
        ...
        db.send_create_signal('devices', ['MedicineFormMedicines'])

        # Adding M2M table for field medicine on 'MedicineFormMedicines'
        db.create_table('devices_medicineformmedicines_medicine', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('medicineformmedicines', models.ForeignKey(orm['devices.medicineformmedicines'], null=False)),
            ('medicine', models.ForeignKey(orm['devices.medicine'], null=False))
        ))
        db.create_unique('devices_medicineformmedicines_medicine', ['medicineformmedicines_id', 'medicine_id'])


    def backwards(self, orm):
        
        # Deleting model 'MedicineFormMedicines'
        db.delete_table('devices_medicineformmedicines')

        # Removing M2M table for field medicine on 'MedicineFormMedicines'
        db.delete_table('devices_medicineformmedicines_medicine')
