...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CommunityWorker.phone_number'
        db.add_column('devices_communityworker', 'phone_number', self.gf('django.db.models.fields.CharField')(max_length=30, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CommunityWorker.phone_number'
        db.delete_column('devices_communityworker', 'phone_number')
