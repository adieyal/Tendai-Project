...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CommunityWorker.active'
        db.add_column('devices_communityworker', 'active', self.gf('django.db.models.fields.BooleanField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CommunityWorker.active'
        db.delete_column('devices_communityworker', 'active')
