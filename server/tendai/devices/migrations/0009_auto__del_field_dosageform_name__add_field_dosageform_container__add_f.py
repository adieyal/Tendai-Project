...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DosageForm.name'
        db.delete_column('devices_dosageform', 'name')

        # Adding field 'DosageForm.container'
        db.add_column('devices_dosageform', 'container', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=30), keep_default=False)

        # Adding field 'DosageForm.containers'
        db.add_column('devices_dosageform', 'containers', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=30), keep_default=False)

        # Adding field 'DosageForm.unit'
        db.add_column('devices_dosageform', 'unit', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=30), keep_default=False)

        # Adding field 'DosageForm.units'
        db.add_column('devices_dosageform', 'units', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=30), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'DosageForm.name'
        db.add_column('devices_dosageform', 'name', self.gf('django.db.models.fields.CharField')(default='unknown', max_length=30), keep_default=False)

        # Deleting field 'DosageForm.container'
        db.delete_column('devices_dosageform', 'container')

        # Deleting field 'DosageForm.containers'
        db.delete_column('devices_dosageform', 'containers')

        # Deleting field 'DosageForm.unit'
        db.delete_column('devices_dosageform', 'unit')

        # Deleting field 'DosageForm.units'
        db.delete_column('devices_dosageform', 'units')
